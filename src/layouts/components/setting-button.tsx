				...
				<div className="flex flex-col gap-6 p-6">
					...
					<div>
						...
						>
							{themeStretch ? (
								...
								>
									<LeftOutlined />
									<div className="border-border flex flex-grow border-b border-dashed" />
									<RightOutlined />
								</div>
							) : (
								<div
								...
								>
									<RightOutlined />
									<div className="border-border flex-grow border-b border-dashed" />
									<LeftOutlined />
								</div>
							)}
						</Card>
					...
					<div>
						...
						<div className="flex flex-col gap-2">
							<div className="text-text-disabled flex items-center justify-between text-sm">
								<div>BreadCrumb</div>
								<Switch
									size="small"
									checked={breadCrumb}
